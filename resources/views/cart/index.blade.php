        ...
        @if ($cartItems->isEmpty())
            ...
            <div class="flex">
                <a href="{{ route('menu.index') }}"
                    class="bg-gray-700 text-white py-2 px-4 rounded hover:bg-gray-600">Add Products</a>
            </div>
        @else
            <div class="overflow-x-auto">
                ...
                <h2 class="mt-6 text-xl font-bold mb-4">Total: ₱{{ $totalPrice }}</h2>
            </div>
            <div class="flex justify-between mt-6">
                <div class="flex gap-2">
                    ...
                    <button type="button" wire:click='checkout()'
                        class="bg-blue-700 text-white py-2 px-4 rounded hover:bg-blue-600">{{ __('Checkout') }}</button>
                </div>
