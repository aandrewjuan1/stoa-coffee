        ...
        <div class="max-w-lg mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md">
            ...
            <div class="md:p-6">
                <div class="p-4 md:p-0">
                    <div class="space-y-4">
                        <h1 class="text-3xl font-bold mb-4">{{ $cartItem->product->name }}</h1>
                        ...
                        <form action="{{ route('cart.update', ['cartItem' => $cartItem ]) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 space-y-2">
                                    <div class="flex items-center">
                                        <input type="radio" id="hot" name="temperature" value="hot" {{in_array('hot', $customizationValues) ? 'checked' : '' }}
                                    ...
                                    <div class="flex items-center">
                                        <input type="radio" id="iced" name="temperature" value="iced" {{in_array('iced', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 space-y-2">
                                    <div class="flex items-center">
                                        <input type="radio" id="16_oz" name="size" value="16oz" {{in_array('16oz', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                        <label for="16_oz" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">16 Oz - Default</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="radio" id="22_oz" name="size" value="22oz" {{in_array('22oz', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 space-y-2">
                                    <div class="flex items-center">
                                        <input type="radio" id="not_sweet" name="sweetness" value="not sweet" {{in_array('not sweet', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                        <label for="not_sweet" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">Not Sweet</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="radio" id="less_sweet" name="sweetness" value="less sweet" {{in_array('less sweet', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                        <label for="less_sweet" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">Less Sweet</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="radio" id="regular_sweetness" name="sweetness" value="regular sweetness" {{in_array('regular sweetness', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 space-y-2">
                                    <div class="flex items-center">
                                        <input type="radio" id="whole_milk" name="milk" value="whole milk" {{in_array('whole milk', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                        <label for="whole_milk" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">Whole</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="radio" id="non_fat_milk" name="milk" value="non-fat milk" {{in_array('non-fat milk', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                        <label for="non_fat_milk" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">Non-fat</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="radio" id="sub_soymilk" name="milk" value="sub soymilk" {{in_array('sub soymilk', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                        <label for="sub_soymilk" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">Sub Soymilk - ₱35</label>
                                    </div>
                                    <div class="flex items-center">
                                        <input type="radio" id="sub_coconutmilk" name="milk" value="sub coconutmilk" {{in_array('sub coconutmilk', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 space-y-2">
                                    <div class="flex items-center">
                                        <input type="checkbox" id="decaf" name="espresso[]" value="decaf" {{in_array('decaf', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" id="add_shot" name="espresso[]" value="add shot" {{in_array('add shot', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2 space-y-2">
                                    <div class="flex items-center">
                                        <input type="checkbox" id="add_vanilla" name="syrup[]" value="add vanilla syrup" {{in_array('add vanilla syrup', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" id="add_caramel" name="syrup[]" value="add caramel syrup" {{in_array('add caramel syrup', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                    ...
                                    <div class="flex items-center"> 
                                        <input type="checkbox" id="add_hazelnut" name="syrup[]" value="add hazelnut syrup" {{in_array('add hazelnut syrup', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" id="add_salt_caramel" name="syrup[]" value="add salted caramel syrup" {{in_array('add salted caramel syrup', $customizationValues) ? 'checked' : '' }}
                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded dark:text-gray-400 dark:border-gray-700 dark:bg-gray-800"
